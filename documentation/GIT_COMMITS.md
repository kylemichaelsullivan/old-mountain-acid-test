...
- `ADD: Music Section Component`
- `ADD: Accordion Component`
- `ADD: Config Schema for Photos Section`
- `ADD: ToTop Scroll Button Component`
...
- `REFACTOR: Rename Config Variables for Better Clarity`
- `REFACTOR: Extract Accordion Logic into Reusable Component`
- `REFACTOR: Optimize Config Deep Merge Function`
...
- `UPDATE: Modify Accordion Component Styling`
- `UPDATE: Update Config Default Values`
- `UPDATE: Enhance Music Section with Spotify Embed`
...
- `FIX: Resolve Accordion Animation Issue on Mobile Devices`
- `ADD: Implement Biography Section with Config Support`
- `REFACTOR: Extract Accordion Logic into Reusable Component`
- `UPDATE: Enhance Music Section with Spotify Embed Support`
...
- Update accordion container grid-template-rows logic
...
- **Section Components**: Music, Videos, Photos, Events, Booking, Support, Socials, Biography
- **Layout Components**: App, Header, Main, Footer
- **Utility Components**: Logo, Accordion, ToTop

### Config System

When committing config-related changes:

- Reference specific config sections: SiteIdentity, Music, Videos, Photos, Contact, Support, Colors, Fonts, Elements, Options
- Mention if changes affect config schema, defaults, or types
- Note if changes require config migration

### Styling Changes

When committing styling changes:

- Reference CSS variables (--epk-\*) when applicable
- Mention specific components or sections affected
- Note if changes affect responsive behavior
